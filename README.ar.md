...
يحتفظ المستودع بمجلد [`assets/examples/`](assets/examples/) للأعمال القادمة. لن يُضاف إلا عمل مكتمل بأسلوب 025 ومؤكد من صاحب المشروع؛ ولن تُستخدم منشورات أو صور من أساليب أخرى كعناصر مؤقتة.

ستعرض النماذج القادمة قدرة 025 على التكيف فقط، ولن تصبح موضوعاتها أو استعاراتها أو ألوانها أو نصوصها أو نسبها مراجع للتوليد أو قيماً افتراضية.

## أربعة مخرجات ومنطق واحد للقراءة المزدوجة
...
| --- | --- | --- |
| `top-bottom` | متكيف مع المصدر | الصورة كاملة في الأعلى، وطبعة 025 الغِشتالتية بألوان موراندي في الأسفل؛ يحتفظ اللوحان بمقاس المصدر وينقسمان 50/50 بدقة |
| `left-right` | متكيف مع المصدر | الصورة كاملة في اليسار، وطبعة 025 الغِشتالتية بألوان موراندي في اليمين؛ يحتفظ اللوحان بمقاس المصدر وينقسمان 50/50 بدقة |
...
الأولوية هي: البكسلات الدقيقة التي يحددها المستخدم، ثم النسبة أو الوجهة، ثم التكيف مع المصدر في الأنماط العادية. نسبة 3:4 في ملف `025.md` كانت لوحة إبداعية أولى وليست قيمة افتراضية صامتة في المهارة الحالية.
...
- **أربعة أعمال مستقلة:** يرجع كل جهاز إلى الصورة الأصلية وحدها، ويستكشف اقتراناً مختلفاً بين الموضوع والصورة الخفية ومحيطاً مشتركاً ولوحة موراندي وتدخلاً نصياً.
...
ينشئ نموذج الصور هيئة الموضوع المرتبطة بالمصدر والصورة الخفية والحد المشترك وانقلاب الشكل والخلفية ومساحات موراندي وأثر الطباعة الحريرية والنص المندمج في الفراغ السلبي. ولا يتولى `scripts/compose_panel.py` سوى تخطيط اللوحة والتركيب النقطي الدقيق بنسبة 50/50 وتثبيت المقاس والمراجعة؛ ولا يرسم العمل برمجياً.
